    ...
    <div className="w-full h-full overflow-x-hidden">
      <div className="w-full h-full absolute left-0 top-0 z-20">
        <div className="relative w-full h-full">
          ...
          <div className="py-24 px-8 lg:px-48">
            <div className="flex flex-col gap-4">
              <h1
                className={cn(
                  inter.className,
                  "text-6xl lg:text-7xl font-extrabold leading-[5rem]"
                )}
              >
                40 anos <br /> de{" "}
          ...
          <div className="lg:float-right flex justify-center lg:justify-end items-center border border-darkGray rounded-xl overflow-x-hidden lg:mx-96 mx-4 lg:w-1/2 xl:w-1/3">
      ...
      <div
        className="hidden xl:block bg-cover bg-left ml-[40%] before:-ml-[70%] w-[60%] h-full relative before:absolute before:w-full before:h-full before:bg-white before:top-0 before:-left-[10%] before:transform before:skew-x-12"
        style={{
