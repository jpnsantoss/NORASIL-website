...
const AboutHeader: FC<AboutHeaderProps> = ({}) => {
  return (
    <div className="w-full lg:px-48 py-16">
      ...
      <div className="grid grid-cols-2 gap-16">
        <div className="flex flex-col justify-between">
          <h1
            className={cn(
              inter.className,
              "text-5xl lg:text-6xl font-semibold leading-[4.5rem] lg:leading-[5rem]"
            )}
          >
          ...
          <Button
            size={"lg"}
            className="text-xl font-bold py-6 px-10 w-fit rounded-lg shadow-md shadow-secondary"
          >
            Ver Obras
          </Button>
        </div>
        <div className="space-y-4 text-2xl mt-4">
